...
compgrad2D <- function(f){
    ...
    out = .Call('find_grad_2D', PACKAGE = 'fdasrvfSpatReg', dfdu, dfdv, f, n, t, d)
...
findphistar <- function(q, b){
    ...
    out = .Call('find_phistar', PACKAGE = 'fdasrvfSpatReg', w, q, b, n, t, d, K)
...
check_crossing <- function(f) {
    ...
    diffeo = .Call('check_cross', PACKAGE = 'fdasrvfSpatReg', f, n, t, D)
