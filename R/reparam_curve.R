...
reparam_curve <- function(beta1,beta2,lambda=0,method="DP",w=0.01,rotated=T,
    ...
    if (method=="DPo"){
        ...
        T1 = rep(0,M)
        size = 0
        ret = .Call('DPQ2', PACKAGE = 'fdasrvfSpatReg', q1i, timet, q2i, timet, n1, M, M, timet, timet, M, M, G, T1, size, lambda, 1);
      ...
      q2i = q2
      dim(q2i) = c(M*n1)
      gam0 = .Call('DPQ', PACKAGE = 'fdasrvfSpatReg', q1i, q2i, n1, M, lambda, 1, 0, rep(0,M))
    } else if (method=="DP2") {
      stop("Not implemented in CRAN version: please download and install from Github (https://github.com/jdtuck/fdasrvf_R)")
        ...
        out = .Call('opt_reparam', PACKAGE = 'fdasrvfSpatReg', c1,c2,M,n1,0.0,TRUE,
        ...
        out = .Call('opt_reparam', PACKAGE = 'fdasrvfSpatReg', c1,c2,M,n1,w,FALSE,
                    rotated,isclosed,skipm,auto,opt,swap,fopts,comtime)
